ARG PHP_VERSION=8.4.5-alpine  # https://hub.docker.com/_/php/tags?page=1&name=8.4
ARG COMPOSER_VERSION=2.8.6    # https://hub.docker.com/_/composer/tags
ARG PHPEXTINST_VERSION=2.7.24  # https://github.com/mlocati/docker-php-extension-installer/releases
