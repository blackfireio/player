...
ARG COMPOSER_VERSION=2.8.8    # https://hub.docker.com/_/composer/tags
ARG PHPEXTINST_VERSION=2.7.28  # https://github.com/mlocati/docker-php-extension-installer/releases
