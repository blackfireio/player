ARG PHP_VERSION=8.4.17-alpine  # https://hub.docker.com/_/php/tags?page=1&name=8.4
ARG COMPOSER_VERSION=2.9.3    # https://hub.docker.com/_/composer/tags
ARG PHPEXTINST_VERSION=2.9.27 # https://github.com/mlocati/docker-php-extension-installer/releases
