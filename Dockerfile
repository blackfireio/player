...
RUN wget -O phive.phar "https://github.com/phar-io/phive/releases/download/0.14.3/phive-0.14.3.phar" && \
    wget -O phive.phar.asc "https://github.com/phar-io/phive/releases/download/0.14.3/phive-0.14.3.phar.asc" && \
